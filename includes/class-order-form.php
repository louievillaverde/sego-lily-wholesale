...
class SLW_Order_Form {
    ...
    public static function cart_state_payload() {
        ...
        // Product-type minimums (6 per Ageless, etc., summed across a product's
        // variations) surface in the same panel + sticky bar so the customer
        // sees "Add 2 more Ageless" live, not only as a block at checkout.
