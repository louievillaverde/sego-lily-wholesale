...
1. **Products > Categories > Add New** to create a "Gift Sets" category.
2. Create four **variable products** under that category:
   - Ageless Gift Set
   - Renewal Gift Set
   - Moxy Gift Set
   - Variety Gift Set
3. On each one, add a "Scent" attribute and create a variation only for the scents you want customers to be able to choose. (Same setup as your existing variable products. Curate the top sellers, leave out anything you don't want offered as a gift set.)
...
- **CSV upload** to download the template, paste your existing spreadsheet, upload
